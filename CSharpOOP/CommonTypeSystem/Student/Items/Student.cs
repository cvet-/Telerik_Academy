    ...
    internal class Student : ICloneable, IComparable<Student>
    {
        ...
        public string SSN
        {
            ...
            private set
            {
                ...
                if (value.Length != 9)
                {
                    throw new ArgumentException("Invald SSN length.");
                }
        ...
        {
            string firstStudentName = (FirstName + MiddleName + LastName).Replace(" ", string.Empty);
            string secondStudentName = (other.FirstName + other.MiddleName + other.LastName).Replace(" ", string.Empty);
            if (firstStudentName != secondStudentName)
            {
                return String.Compare(firstStudentName, secondStudentName, StringComparison.InvariantCulture);
            }
