...
class Polynomials
{
    ...
    static void Main()
    {
        Console.Write("Enter degree of first polynomial: ");
        int degree = int.Parse(Console.ReadLine());
        Console.WriteLine("Enter coefficient from higest to lowest power: ");
        decimal[] array1 = new decimal[degree + 1];
        DeclareArray(array1);

        Console.Write("Enter degree of second polynomial: ");
